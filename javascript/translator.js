...
function english_to_brail(str) {
 ...
 // let input =
 //   ".....OO.OO..O..O..O.O.O.O.O.O.O..OO............O.OOO.O.....OO..OO.O.OOO.O.O.O.OO.O..";
 ...
 function invertKeyValuePairs(obj) {
  return Object.entries(obj).reduce((acc, [key, value]) => {
    // Check if the value is already a key in the accumulator
    if (acc.hasOwnProperty(value)) {
      // If it is, make the value an array if it's not already
      ...
      // If it's not, just set the key-value pair
      acc[value] = key;
    }
    return acc;
  }, {});

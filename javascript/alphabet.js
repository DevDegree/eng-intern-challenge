...
const brailleSpecialCharacters = {
  ".": "..OO.O",
  ",": "..O...",
  "?": "..O.OO",
  "!": "..OOO.",
...
// Reverse mapping: brailleSpecialCharacters
const englishSpecialCharacters = {};
for (const [key, value] of Object.entries(brailleSpecialCharacters)) {
  englishSpecialCharacters[value] = key;
}

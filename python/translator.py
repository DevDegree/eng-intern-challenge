...
# Updated dictionary for mapping Braille to English according to the provided image
...
# Updated dictionary for mapping English to Braille explicitly
english_to_braille = {

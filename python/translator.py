...
# No need for separate digits mapping since digits are represented by letters a-j preceded by the number indicator
...
# Digits are same as letters a-j, so no separate mapping needed

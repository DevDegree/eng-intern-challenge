...
BRAILLE_TO_ENG_LETTERS = {v: k for k, v in ENG_TO_BRAILLE_LETTERS.items()}
BRAILLE_TO_ENG_NUMBERS = {v: k for k, v in ENG_TO_BRAILLE_NUMBERS.items()}
BRAILLE_TO_ENG_SPECIALS = {v: k for k, v in ENG_TO_BRAILLE_SPECIALS.items()}
...
def main():
    ...
    print(convert_to_braille_or_english(input_text))

...
def translate_braille(text, braille_dict, braille_numbers_dict):
  result = ""
  is_number = False
  is_capital = False
...
def translate_english(text, english_dict):
  result = ""
  is_number = False
...
if is_braille(input_args):
  print(translate_braille(input_args, braille_dict, braille_numbers_dict))
else:
  print(translate_english(input_args, english_dict))
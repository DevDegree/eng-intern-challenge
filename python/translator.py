...
class Translator:
    ...
    def translate(self) -> str:
        language: Language = self._find_language()
    ...
    def _find_language(self) -> Language:
        ...
        if self.text == SIX_O or not (is_multiple_of_six and is_all_chars_O_or_dot):
    ...
    def _english_to_braille(self) -> str:
        ...
        for c in self.text:
            ...
            translated_chars.append(ENGLISH_TO_BRAILLE[c.lower()])
